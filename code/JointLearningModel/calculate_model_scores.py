...
# to be modified
class Quantity_Slot_Filling_and_Intent_Detection_Calculate(Snips_Slot_Filling_and_Intent_Detection_Calculate):
    def get_intent_labels(self):
    ...
    def get_slot_labels(self):
        """only contain Task labels"""
        return ['B-Attribute','I-Attribute','B-Modifier','I-Modifier',
